...
if __name__ == "__main__":
    ...
    default_output = "/opt/ml/processing/output/baseline_features_raw.pkl" if os.path.exists("/opt/ml/processing/input") else "pipelines/lead_conversion_rate/model/pickles/baseline_features_raw"
